...
class CameraThread(QThread):
    ...
    def __init__(self, parent=None):
        ...
        self.box_size = 500  # Größe des Kastens (673x673 Pixel)
    ...
    def process_image(self, frame):
        ...
        start_x = center_x - self.box_size // 2
        start_y = center_y - self.box_size // 2
        end_x = start_x + self.box_size
        end_y = start_y + self.box_size
