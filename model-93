...
class SettingsWindow(QDialog):
    ...
    def init_ui(self):
        ...
        self.parameters_dropdown.setCurrentText("13B")
        ...
        model_button = QPushButton(" Update")
        model_button.setIcon(QIcon('C:\\Users\\julia\\PycharmProjects\\Xcpp\\update.svg'))
...
class ModelWindow(QDialog):
    def __init__(self, parent=None):
        super().__init__(parent)
        self.setWindowTitle("Settings")
        self.setGeometry(150, 50, 300, 300)
        self.setWindowFlags(Qt.Window | Qt.FramelessWindowHint)  # Fenster ohne Rahmen
        self.setAttribute(Qt.WA_TranslucentBackground)
        self.init_ui()
