...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.glass_frame2.setStyleSheet("""
            ...
            color: #000000;
        """)
        self.glass_frame2.setFixedSize(525, 200)
        ...
        y_position = 575  # Vertikale Verschiebung um 400px
        ...
        shadow_effect2.setColor(QColor(0, 0, 0, 160))  # Schwarze Farbe für den Schatten
        shadow_effect2.setOffset(7, 7)
        ...
        self.button1.setGraphicsEffect(shadow_effect2)
        ...
        # Animationen
        rotation_animation = QPropertyAnimation(shadow_effect2, b"angle")
        rotation_animation.setDuration(300)
        rotation_animation.setStartValue(0)
        rotation_animation.setEndValue(216)  # 60% von 360 Grad

        hover_animation = QPropertyAnimation(self.button1, b"opacity")
        hover_animation.setDuration(300)
        hover_animation.setStartValue(1)
        hover_animation.setEndValue(0.7)

        # Verknüpfung der Animationen mit Hover-Ereignissen
        self.button1.enterEvent = lambda event: (rotation_animation.start(), hover_animation.start())
        self.button1.leaveEvent = lambda event: (rotation_animation.stop(), hover_animation.stop())
        ...
        self.button2.setIconSize(QtCore.QSize(70, 70))  # Hier Größe der SVG-Datei angeben
        ...
        shadow_effect.setColor(QColor(0, 0, 0, 160))  # Schwarze Farbe für den Schatten
        shadow_effect.setOffset(7, 7)
        self.button3.setIconSize(QtCore.QSize(63, 63))  # Hier Größe der SVG-Datei angeben
        self.button3.setIconSize(QSize(63, 63))  # Hier Größe der SVG-Datei angeben
        ...
        shadow_effect.setColor(QColor(0, 0, 0, 160))  # Schwarze Farbe für den Schatten
        shadow_effect.setOffset(7, 7)
        self.button4.setIconSize(QtCore.QSize(65, 65))  # Hier Größe der SVG-Datei angeben
        self.button4.setIconSize(QSize(65, 65))  # Hier Größe der SVG-Datei angeben
        ...
        self.button_layout.addWidget(self.button1)
        self.button_layout.addSpacing(25)
        self.button_layout.addWidget(self.button2)
        self.button_layout.addSpacing(5)
        self.button_layout.addWidget(self.button4)
