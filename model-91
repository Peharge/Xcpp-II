...
class SettingsWindow(QDialog):
    def __init__(self, parent=None):
        ...
        self.setGeometry(1200, 50, 600, 500)
    ...
    def init_ui(self):
        ...
        try:
            ...
            gpu = "Nicht verfügbar (OpenCL nicht installiert)"
        ...
        general_layout.addRow(QLabel(f"RAM: <span style='color: red;'>{ram:.2f}</span> GB"))
        general_layout.addRow(QLabel(f"Number of Threads: <span style='color: red;'>{cpu_threads}</span>"))
        general_layout.addRow(QLabel(f"Chip type/CPU model: <span style='color: red;'>{cpu_model}</span>"))
        general_layout.addRow(QLabel(f"Graphics card(s): <span style='color: red;'>{gpu}</span> No CUDA"))
        general_layout.addRow(QLabel(f""))
        general_layout.addRow(QLabel(f"Maximum <span style='color: red;'>13B</span> recommended"))

        # Theme-Auswahl
        self.theme_dropdown = QComboBox()
        self.theme_dropdown.addItems(["7B", "13B", "32B", "70B", "301B", "512B", "1024B", "1536B"])
        # Standardmäßig auf "13B" setzen
        self.theme_dropdown.setCurrentText("13B")
        general_layout.addRow(QLabel("Parameters:"), self.theme_dropdown)

        general_layout.addRow(QLabel(f""))
        general_layout.addRow(QLabel(f"Storage space: <span style='color: green;'>{disk:.2f}</span> GB"))
        general_layout.addRow(QLabel(f"System: <span style='color: green;'>{system_info}</span>"))
        general_layout.addRow(QLabel(f"Xcpp version: <span style='color: green;'>1</span>"))
        general_layout.addRow(QLabel(f"Peharge security: <span style='color: green;'>active</span>"))
        general_layout.addRow(QLabel(f""))
        general_layout.addRow(QLabel(f"Xcpp 13B uses <span style='color: orange;'>13 GB</span> of your RAM"))
        general_layout.addRow(QLabel(f"Xcpp 13B uses <span style='color: red;'>91%</span> of your CPU power"))
        general_layout.addRow(QLabel(f"Xcpp 13B uses <span style='color: green;'>79 GB</span> of your disk space"))
...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.button3.setIcon(QIcon('C:\\Users\\julia\\PycharmProjects\\Xcpp\\peharge-logo-p-3.svg'))
        ...
        self.button5.setIcon(QIcon('C:\\Users\\julia\\PycharmProjects\\Xcpp\\img2.svg'))
