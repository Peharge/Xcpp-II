...
from PyQt5.QtWidgets import QDialog, QSlider, QLabel, QVBoxLayout, QPushButton
...
class SettingsWindow(QDialog):
    ...
    def initUI(self):
        ...
        # Layout für das Einstellungsfenster
        layout = QVBoxLayout()

        # Kontrastregler
        self.contrast_label = QLabel("Contrast: 1.0", self)
        layout.addWidget(self.contrast_label)

        self.contrast_slider = QSlider(Qt.Horizontal, self)
        self.contrast_slider.setMinimum(1)
        self.contrast_slider.setMaximum(100)
        self.contrast_slider.setValue(10)  # Initialwert des Sliders
    ...
    def apply_settings(self):
        contrast_value = self.contrast_slider.value() / 10
        # Hier kannst du den Kontrastwert anwenden
        print(f"Applied contrast: {contrast_value}")
        self.accept()
