...
class SicherheitsbewertungThread(QThread):
    ...
    def run(self):
        ...
        self.finished.emit("<span style='color: blue;'>Sicherheitsüberprüfung abgeschlossen.\nKeine offensichtlichen Sicherheitsrisiken gefunden.<span>")
...
class StilvollesSicherheitsfenster(QDialog):
    ...
    def init_ui(self):
        ...
        bewertung_btn.setFixedSize(80, 40)
