...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        # Erstelle ein horizontal ausgerichtetes Layout für die Buttons
        button_layout = QHBoxLayout(self.main_widget)
        button_layout.setAlignment(Qt.AlignCenter)  # Zentriere Layout im Haupt-Widget

        self.button = QPushButton("X", self.glass_frame)
        shadow_effect = QGraphicsDropShadowEffect(self)
        shadow_effect.setBlurRadius(10)
        shadow_effect.setColor(QColor(0, 0, 0, 160))  # Dark shadow
        shadow_effect.setOffset(5, 5)
