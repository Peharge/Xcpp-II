...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.button1.setIconSize(QtCore.QSize(25, 25))  # Hier Größe der SVG-Datei angeben
        self.button1.setIconSize(QSize(25, 25))  # Hier Größe der SVG-Datei angeben
        ...
        shadow_effect.setColor(QColor(0, 0, 0, 160))  # Schwarze Farbe für den Schatten
        shadow_effect.setOffset(7, 7)
        self.button2.setIconSize(QtCore.QSize(25, 25))  # Hier Größe der SVG-Datei angeben
        self.button2.setIconSize(QSize(25, 25))  # Hier Größe der SVG-Datei angeben
        ...
        self.button3.setIcon(QIcon('C:\\Users\\julia\\PycharmProjects\\Xcpp\\setting.svg'))
        shadow_effect = QGraphicsDropShadowEffect(self)
        shadow_effect.setBlurRadius(10)
        shadow_effect.setColor(QColor(0, 0, 0, 160))  # Schwarze Farbe für den Schatten
        shadow_effect.setOffset(7, 7)
