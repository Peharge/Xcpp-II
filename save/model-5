...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.camera_view.setGeometry(0, 0, self.width(), self.height())  # Full window size
        ...
        self.glass_frame.setStyleSheet("""
            ...
            color: #ffffff;
        """)
        self.glass_frame.setGeometry(50, 50, 700, 500)  # Adjust the size and position
        self.main_layout.addWidget(self.glass_frame)

        # Layout inside glass frame
        ...
        self.animation_label = QLabel(self.glass_frame)
        self.movie = QMovie("peharge-speak.gif")
        self.animation_label.setMovie(self.movie)
        self.movie.start()
        self.animation_label.setGeometry(0, 0, 700, 400)  # Adjust the size and position
