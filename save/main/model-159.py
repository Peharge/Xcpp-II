...
class StilvollesSicherheitsfenster(QDialog):
    ...
    def init_ui(self):
        ...
        self.bewertung_btn.setIconSize(QSize(38, 38))  # Hier Größe der SVG-Datei angeben
...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.glass_frame2.setStyleSheet("""
            ...
            color: #000000;
        """)
        self.glass_frame2.setFixedSize(625, 155)
...
class VoiceAnimationWindow(QMainWindow):
    def __init__(self):
        ...
        self.setGeometry(460, 340, 1000, 400)  # Increase the height to accommodate the label
        self.initUI()
    ...
    def initUI(self):
        ...
        self.decibel_label.setStyleSheet("color: white; font-size: 16px;")
        self.layout.addWidget(self.decibel_label)
    ...
    def audio_callback(self, indata, frames, time, status):
        ...
        if max_val > 0:
            ...
            self.current_decibel = 20 * np.log10(max_val)
        else:
