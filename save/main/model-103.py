...
class MainWindow(QMainWindow):
    ...
    def process_audio(self, audio):
        try:
            ...
            llama3_output = res['message']['content'] #no ['message'], I think so, beacuse xtts dont need content (It dont have to red the imput text from the user, but it is working grat, like ist is ;-)!!!
