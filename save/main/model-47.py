...
class SettingsWindow(QDialog):
    ...
    def init_ui(self):
        ...
        self.volume_slider.setFont(QFont('Arial', 20, QFont.Bold))
        ...
        self.language_dropdown.setFont(QFont('Arial', 14, QFont.Bold))
