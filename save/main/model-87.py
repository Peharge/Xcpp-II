...
class SettingsWindow(QDialog):
    ...
    def init_ui(self):
        ...
        general_layout.addRow(QLabel(f"Anzahl der Threads: <span style='color: red;'>{cpu_threads}</span>"))
        general_layout.addRow(QLabel(f"Chipart/CPU-Modell: <span style='color: red;'>{cpu_model}</span>"))
        general_layout.addRow(QLabel(f"Grafikkarte(n): <span style='color: red;'>{gpu}</span> Kein CUDA"))
        general_layout.addRow(QLabel(f""))
        general_layout.addRow(QLabel(f"<span style='color: red;'>Maximal 13B empfohlen</span>"))
        ...
        general_layout.addRow(QLabel(f""))
        general_layout.addRow(QLabel(f"Speicherplatz: <span style='color: green;'>{disk:.2f}</span> GB"))
        general_layout.addRow(QLabel(f"System: <span style='color: green;'>{system_info}</span>"))
        general_layout.addRow(QLabel(f""))
        general_layout.addRow(QLabel(f"Xcpp 13B verwendet <span style='color: orange;'>12 GB</span> Ihrers RAMs"))
        general_layout.addRow(QLabel(f"Xcpp 13B verwendet <span style='color: red;'>91%</span> Ihrer CPU Leistung"))
        general_layout.addRow(QLabel(f"Xcpp 13B verwendet <span style='color: green;'>79 GB</span> Ihres Speicherplatzes"))
