...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.glass_frame2.setStyleSheet("""
            ...
            color: #000000;
        """)
        self.glass_frame2.setFixedSize(450, 150)
        ...
        self.button1.setIconSize(QtCore.QSize(55, 55))  # Hier Größe der SVG-Datei angeben
        self.button1.setIconSize(QSize(55, 55))  # Hier Größe der SVG-Datei angeben
        ...
        self.button2.setIconSize(QtCore.QSize(55, 55))  # Hier Größe der SVG-Datei angeben
        self.button2.setIconSize(QSize(55, 55))  # Hier Größe der SVG-Datei angeben
        ...
        shadow_effect.setColor(QColor(0, 0, 0, 160))  # Schwarze Farbe für den Schatten
        shadow_effect.setOffset(7, 7)
        self.button3.setIconSize(QtCore.QSize(53, 53))  # Hier Größe der SVG-Datei angeben
        self.button3.setIconSize(QSize(53, 53))  # Hier Größe der SVG-Datei angeben
        ...
        shadow_effect.setColor(QColor(0, 0, 0, 160))  # Schwarze Farbe für den Schatten
        shadow_effect.setOffset(7, 7)
        self.button4.setIconSize(QtCore.QSize(50, 50))  # Hier Größe der SVG-Datei angeben
        self.button4.setIconSize(QSize(50, 50))  # Hier Größe der SVG-Datei angeben
