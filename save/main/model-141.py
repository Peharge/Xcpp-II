...
class SettingsWindow(QDialog):
    ...
    def init_ui(self):
        ...
        self.apply_button.setFixedSize(75, 40)
        ...
        self.cancel_button.setFixedSize(75, 40)
        ...
        self.update_button.setFixedSize(75, 40)
        ...
        self.model_button.setFixedSize(75, 40)
        ...
        self.sec_button.setFixedSize(75, 40)
...
class StilvollesSicherheitsfenster(QDialog):
    ...
    def init_ui(self):
        ...
        bewertung_btn.clicked.connect(self.play_sound_1)
...
class MainWindow(QMainWindow):
    ...
    def close_window(self):
        ...
        QTimer.singleShot(300, self.close)  # 300 Millisekunden = 0.3 Sekunden
