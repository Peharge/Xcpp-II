...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.button3.setIconSize(QtCore.QSize(40, 40))  # Hier Größe der SVG-Datei angeben
        self.button3.setIconSize(QSize(40, 40))  # Hier Größe der SVG-Datei angeben
