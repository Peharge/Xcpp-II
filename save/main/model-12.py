...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.label.setStyleSheet("color: rgba(255, 0, 0, 160);")
    ...
    def process_audio(self, audio):
        try:
            ...
            llama3_output = run_command_and_get_output("ollama run llava-llama3", text + f" :(C:/Users/julia/PycharmProjects/Xcpp/{image_path})")
