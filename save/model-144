...
class SettingsWindow(QDialog):
    ...
    def init_ui(self):
        ...
        self.apply_button.setFixedSize(40, 30)
        self.apply_button.setIconSize(QSize(20, 20))  # Hier Größe der SVG-Datei angeben
        ...
        self.cancel_button.setFixedSize(40, 30)
        self.cancel_button.setIconSize(QSize(20, 20))  # Hier Größe der SVG-Datei angeben
        ...
        self.update_button.setFixedSize(40, 30)
        self.update_button.setIconSize(QSize(20, 20))  # Hier Größe der SVG-Datei angeben
        ...
        self.model_button.setIconSize(QSize(20, 20))  # Hier Größe der SVG-Datei angeben
        ...
        self.sec_button.setFixedSize(40, 30)
        self.sec_button.setIconSize(QSize(20, 20))  # Hier Größe der SVG-Datei angeben
    ...
    def move_apply_button_up(self):
        self.apply_button.move(self.apply_button.x(), self.apply_button.y() - 5)
    ...
    def move_cancel_button_up(self):
        self.cancel_button.move(self.cancel_button.x(), self.cancel_button.y() - 5)
    ...
    def move_update_button_up(self):
        self.update_button.move(self.update_button.x(), self.update_button.y() - 5)
    ...
    def move_model_button_up(self):
        self.model_button.move(self.model_button.x(), self.model_button.y() - 5)
    ...
    def move_sec_button_up(self):
        self.sec_button.move(self.sec_button.x(), self.sec_button.y() - 5)
...
class StilvollesSicherheitsfenster(QDialog):
    ...
    def init_ui(self):
        ...
        self.bewertung_btn.setFixedSize(40, 30)
        self.bewertung_btn.setIconSize(QSize(25, 25))  # Hier Größe der SVG-Datei angeben
    ...
    def move_bewertung_btn_up(self):
        self.bewertung_btn.move(self.bewertung_btn.x(), self.bewertung_btn.y() - 5)
