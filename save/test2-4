...
class VideoPlayer(QMainWindow):
    def __init__(self, video_path):
        ...
        self.text_animation_duration = 5000  # Textanimation 3 Sekunden lang
        self.text_display_duration = 5000  # Text wird für 5 Sekunden angezeigt
        self.text_disappearance_duration = 5000  # Text wird für 3 Sekunden wegschreiben
        ...
        text_sound_url = QUrl.fromLocalFile("C:/Users/julia/PycharmProjects/Xcpp/swoosh-transition-with-metal-overtones-142375.mp3")  # Pfad zur Typ-Schreib-Sounddatei
