...
class SettingsWindow(QDialog):
    ...
    def init_ui(self):
        ...
        general_layout.addRow(QLabel(f""))
        general_layout.addRow(QLabel(f"Xc++ 13B uses <span style='color: blue;'>13 GB</span> of your RAM"))
        general_layout.addRow(QLabel(f"Xc++ 13B uses <span style='color: blue;'>91%</span> of your CPU power"))
...
class ModelWindow(QDialog):
    ...
    def init_ui(self):
        ...
        # Allgemeine Einstellungen Gruppe
        general_group = QGroupBox("Peharge")
        general_group.setStyleSheet("""
            QGroupBox {
                background-color: rgba(255, 255, 255, 0);
                font-weight: bold;
...
import sys
from PyQt5.QtWidgets import QApplication, QDialog, QVBoxLayout, QLabel, QPushButton, QProgressBar, QFrame, QHBoxLayout
...
class SicherheitsbewertungThread(QThread):
    ...
    def run(self):
        ...
        self.finished.emit("Sicherheitsüberprüfung abgeschlossen.\nKeine offensichtlichen Sicherheitsrisiken gefunden.")


class StilvollesSicherheitsfenster(QDialog):  # Ändere QWidget in QDialog
    def __init__(self, parent=None):
        super().__init__(parent)
        self.setWindowTitle("Xc++ Info")
        self.setGeometry(113, 50, 500, 350)
    ...
    def init_ui(self):
        ...
        title_layout = QHBoxLayout()
        title_label = QLabel("Xc++ Info")
        title_label.setStyleSheet("color: #000000; font-size: 16px; font-weight: bold;")
        title_layout.addWidget(title_label)
        title_layout.addStretch()
        ...
        titel_label = QLabel("Sicherheitsbewertung", self)
        titel_label.setFont(QFont("Arial", 16, QFont.Bold))
        titel_label.setStyleSheet("color: #00BFFF;")
        titel_label.setAlignment(Qt.AlignCenter)
        content_layout.addWidget(titel_label)

        self.sicherheitsbewertung_label = QLabel("Bewertung des Sicherheitscodes:", self)
        self.sicherheitsbewertung_label.setFont(font)
        self.sicherheitsbewertung_label.setStyleSheet("color: #FFFFFF;")
        ...
        self.sicherheitsstatus_label.setStyleSheet("color: #FFFFFF;")
        ...
        bewertung_btn = QPushButton("Sicherheitsbewertung durchführen", self)
        bewertung_btn.setFont(font)
        bewertung_btn.setStyleSheet(
            "background-color: #00BFFF; color: #FFFFFF; border: none; padding: 10px;")
    ...
    def start_sicherheitsbewertung(self):
        ...
        self.sicherheitsstatus_label.setText("Sicherheitsüberprüfung läuft...")
...
if __name__ == '__main__':
    ...
    fenster = StilvollesSicherheitsfenster()
    fenster.show()  # Verwende show() anstelle von exec_()
    sys.exit(app.exec_())
