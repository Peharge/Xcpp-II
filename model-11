...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.button.setFont(QFont('Arial', 17, QFont.Bold))
        ...
        self.button.setFixedSize(130, 70)  # Adjust size
    ...
    def process_audio(self, audio):
        try:
            ...
            llama3_output = run_command_and_get_output("ollama run llava:7b", text + f" :(C:/Users/julia/PycharmProjects/Xcpp/{image_path})")
