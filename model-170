...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.glass_frame2.setStyleSheet("""
            ...
            color: #000000;
        """)
        self.glass_frame2.setFixedSize(625, 165)
        ...
        self.label.setFont(QFont('Aptos Black', 17, QFont.Bold))
        ...
        self.button1.setIconSize(QSize(71, 71))  # Hier Größe der SVG-Datei angeben
        ...
        # Setze die Größe und das Layout des Buttons
        self.button5.setIconSize(QSize(68, 68))
