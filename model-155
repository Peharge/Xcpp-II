...
class AudioThread(QThread):
    ...
    def run(self):
        try:
            fs = 16000
            silence_threshold = 0.01  # Schwellenwert für "Stille"
            silence_duration = 1  # Zeit in Sekunden, die als "Stille" betrachtet wird
            recording = []
...
class SettingsWindow(QDialog):
    ...
    def init_ui(self):
        ...
        self.apply_button.setIconSize(QSize(28, 28))  # Hier Größe der SVG-Datei angeben
        ...
        self.cancel_button.setIconSize(QSize(28, 28))  # Hier Größe der SVG-Datei angeben
        ...
        self.update_button.setIconSize(QSize(28, 28))  # Hier Größe der SVG-Datei angeben
        ...
        self.model_button.setIconSize(QSize(28, 28))  # Hier Größe der SVG-Datei angeben
        ...
        self.sec_button.setIconSize(QSize(28, 28))  # Hier Größe der SVG-Datei angeben
        ...
        self.au_button.setIcon(QIcon('C:\\Users\\julia\\PycharmProjects\\Xcpp\\sec.svg'))
        self.au_button.setFixedSize(40, 40)
        self.au_button.setIconSize(QSize(28, 28))  # Hier Größe der SVG-Datei angeben
        self.au_button.clicked.connect(self.play_sound_1)
        self.au_button.setStyleSheet("""
            QPushButton {
                color: #000000;
                background-color: rgba(255, 255, 255, 0);
            }
        ...
        """)
        self.au_button.clicked.connect(self.open_AudioFenster)
        ...
        buttons_layout.addWidget(self.au_button)
...
class StilvollesSicherheitsfenster(QDialog):
    ...
    def init_ui(self):
        ...
        self.bewertung_btn.setFixedSize(40, 40)
        self.bewertung_btn.setIconSize(QSize(30, 30))  # Hier Größe der SVG-Datei angeben
        ...
        content_layout.setAlignment(self.bewertung_btn, Qt.AlignCenter)  # Zentriere den Button im Layout
...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.glass_frame2.setStyleSheet("""
            ...
            color: #000000;
        """)
        self.glass_frame2.setFixedSize(650, 160)
        ...
        self.button6.setIcon(QIcon('C:\\Users\\julia\\PycharmProjects\\Xcpp\\audio.svg'))
        # Schatteneffekt für den Button
        self.shadow_effect6 = QGraphicsDropShadowEffect(self)
        self.shadow_effect6.setBlurRadius(10)
        self.shadow_effect6.setColor(QColor(0, 0, 0, 160))  # Schwarze Farbe für den Schatten
        self.shadow_effect6.setOffset(7, 7)
        self.button6.setGraphicsEffect(self.shadow_effect6)

        # Setze die Größe und das Layout des Buttons
        self.button6.setIconSize(QSize(57, 57))
    ...
    def open_AudioFenster(self):
        if self.voice_window is None:
            ...
            # Wenn das Fenster bereits geöffnet ist, schließe es
    ...
    def close_window(self):
        # Warte 3 Sekunden und schließe das Fenster danach
        QTimer.singleShot(350, self.close)  # 300 Millisekunden = 0.3 Sekunden
...
class VoiceAnimationWindow(QMainWindow):
    def __init__(self):
        ...
        self.setGeometry(560, 340, 800, 400)
        self.initUI()
    ...
    def audio_callback(self, indata, frames, time, status):
        ...
        # Berechne den RMS-Wert des aktuellen Audio-Blocks
        rms = np.sqrt(np.mean(indata ** 2))

        # Ein niedriger Schwellenwert, um auch leise, hörbare Töne zu erfassen
        threshold = 0.005

        # Wenn der RMS-Wert den Schwellenwert überschreitet, verarbeite die Daten
        if rms > threshold:
            # Normalisiere die Daten, um die volle Amplitude zu nutzen
            normalized_data = np.squeeze(indata) / np.max(np.abs(indata))
            self.audio_data = normalized_data
        else:
            # Wenn das Signal unter dem Schwellenwert liegt, ignoriere es
