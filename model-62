...
import os
from PyQt5.QtWidgets import QWidget, QVBoxLayout, QLabel, QScrollArea, QScrollBar
...
class ImageGallery(QWidget):
    ...
    def init_ui(self):
        ...
        # Setze die Mindestgröße des Fensters auf 400x400 Pixel
        self.setMinimumSize(QSize(400, 400, 400, 400))
        ...
        # Sicherstellen, dass das Layout den gesamten verfügbaren Platz nutzt
