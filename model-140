...
class SettingsWindow(QDialog):
    ...
    def init_ui(self):
        ...
        apply_button.setFixedSize(75, 40)
        apply_button.setIconSize(QSize(40, 40))  # Hier Größe der SVG-Datei angeben
        ...
        cancel_button.setFixedSize(75, 40)
        cancel_button.setIconSize(QSize(40, 40))  # Hier Größe der SVG-Datei angeben
        ...
        update_button.setFixedSize(75, 40)
        update_button.setIconSize(QSize(40, 40))  # Hier Größe der SVG-Datei angeben
        ...
        model_button.setFixedSize(75, 40)
        model_button.setIconSize(QSize(40, 40))  # Hier Größe der SVG-Datei angeben
        ...
        sec_button = QPushButton()
        sec_button.setIcon(QIcon('C:\\Users\\julia\\PycharmProjects\\Xcpp\\sec.svg'))
        sec_button.setFixedSize(75, 40)
        sec_button.setIconSize(QSize(40, 40))  # Hier Größe der SVG-Datei angeben
        sec_button.clicked.connect(self.play_sound_1)
