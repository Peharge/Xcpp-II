...
class SettingsWindow(QDialog):
    ...
    def init_ui(self):
        ...
        general_layout.addRow(QLabel(f"\nRAM: <span style='color: red;'>{ram:.2f}</span> GB RAM"))
        ...
        general_layout.addRow(QLabel(f"\n<span style='color: red;'>Maximal 13B empfohlen</span>\n"))
        ...
        general_layout.addRow(QLabel(f"Speicherplatz: {disk:.2f} GB"))
        general_layout.addRow(QLabel(f"System: {system_info}"))
