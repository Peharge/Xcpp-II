...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.button2.setIconSize(QSize(55, 55))
        ...
        # Setze die Größe und das Layout des Buttons
        self.button3.setIconSize(QSize(55, 55))
        ...
        # Setze die Größe und das Layout des Buttons
        self.button4.setIconSize(QSize(55, 55))
        self.button4.setFixedSize(75, 75)
    ...
    def process_with_professional_tool(self, text_output, language="en"):
        try:
            if language == "en":
                model_name = "tts_models/en/ljspeech/glow-tts" #tts_models/en/ljspeech/glow-tts //
            elif language == "de":
            ...
            speaker_wav_path = os.path.join("C:/Users/julia/PycharmProjects/Xcpp/about-anger-179423.mp3")
