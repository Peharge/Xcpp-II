...
class SettingsWindow(QDialog):
    def __init__(self, parent=None):
        ...
        self.setGeometry(1128, 100, 600, 500)
    ...
    def init_ui(self):
        ...
        general_layout.addRow(QLabel(f"Ihr PC hat {ram:.2f} GB RAM"))
        general_layout.addRow(QLabel(f"Speicherplatz: {disk:.2f} GB"))
        general_layout.addRow(QLabel(f"Anzahl der Threads: {cpu_threads}"))
        general_layout.addRow(QLabel(f"Grafikkarte(n): {gpu}"))
        general_layout.addRow(QLabel(f"Chipart/CPU-Modell: {cpu_model}"))
