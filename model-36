...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.glass_frame2.setStyleSheet("""
            ...
            color: #000000;
        """)
        self.glass_frame2.setFixedSize(650, 200)
        ...
        shadow_effect.setColor(QColor(0, 0, 0, 160))  # Schwarze Farbe für den Schatten
        shadow_effect.setOffset(7, 7)
        self.button3.setIconSize(QtCore.QSize(60, 60))  # Hier Größe der SVG-Datei angeben
        self.button3.setIconSize(QSize(60, 60))  # Hier Größe der SVG-Datei angeben
        ...
        shadow_effect.setColor(QColor(0, 0, 0, 160))  # Schwarze Farbe für den Schatten
        shadow_effect.setOffset(7, 7)
        self.button4.setIconSize(QtCore.QSize(70, 70))  # Hier Größe der SVG-Datei angeben
        self.button4.setIconSize(QSize(70, 70))  # Hier Größe der SVG-Datei angeben
