...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        logo_pixmap = QPixmap(
            "C:\\Users\\julia\\OneDrive - Gewerbeschule Lörrach\\Pictures\\software\\peharge-logo3.6.ico").scaled(30,
                                                                                                                  30,
                                                                                                                  Qt.KeepAspectRatio,
                                                                                                                  Qt.SmoothTransformation)
        self.logo_label.setPixmap(logo_pixmap)

        # Logo oben rechts positionieren mit 15 Pixel Abstand
        self.logo_label.setGeometry(self.width() - logo_pixmap.width() - 15, 15, logo_pixmap.width(),
                                    logo_pixmap.height())
        ...
        self.button3.setIcon(QIcon('C:\\Users\\julia\\PycharmProjects\\Xcpp\\setting - kopie.svg'))
        shadow_effect = QGraphicsDropShadowEffect(self)
        shadow_effect.setBlurRadius(10)
        shadow_effect.setColor(QColor(0, 0, 0, 160))  # Schwarze Farbe für den Schatten
        shadow_effect.setOffset(7, 7)
        self.button3.setIconSize(QtCore.QSize(55, 55))  # Hier Größe der SVG-Datei angeben
        self.button3.setIconSize(QSize(55, 55))  # Hier Größe der SVG-Datei angeben
        ...
        self.button_layout.addWidget(self.button2)
        self.button_layout.addSpacing(38)
        self.button_layout.addWidget(self.button3)
    ...
    def resizeEvent(self, event):
        ...
        # Logo neu positionieren, falls sich die Fenstergröße ändert
        if hasattr(self, 'logo_label'):
            logo_pixmap = self.logo_label.pixmap()
            self.logo_label.setGeometry(self.width() - logo_pixmap.width() - 15, 15, logo_pixmap.width(), logo_pixmap.height())
